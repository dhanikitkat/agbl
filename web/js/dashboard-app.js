(function () {
  ...
  function fillSettingsForm(s) {
    ...
    ['store_name', 'wa_number', 'wallet_number', 'rek_mandiri', 'rek_permata', 'rek_jago', 'qris_url', 'logo_url', 'notify_email', 'email_subject_prefix', 'email_thankyou_text', 'menu_photos_folder_id', 'menu_photos_folder_url', 'menu_photos_base_url'].forEach(function (k) {
    ...
    AGBL.bindBrandLogo(document.getElementById('storeLogo'), s);
