(function () {
  ...
  function fillSettingsForm(s) {
    ...
    ['store_name', 'wa_number', 'wallet_number', 'rek_mandiri', 'rek_permata', 'rek_jago', 'qris_url', 'logo_url', 'menu_photos_folder_id', 'menu_photos_folder_url', 'menu_photos_base_url'].forEach(function (k) {
